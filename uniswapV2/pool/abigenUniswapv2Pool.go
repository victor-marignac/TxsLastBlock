...
func (_Pool *PoolCaller) MINIMUMLIQUIDITY(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Pool.contract.Call(opts, &out, "MINIMUM_LIQUIDITY")
...
//
// Solidity: function MINIMUM_LIQUIDITY() view returns(uint256)
func (_Pool *PoolSession) MINIMUMLIQUIDITY() (*big.Int, error) {
	return _Pool.Contract.MINIMUMLIQUIDITY(&_Pool.CallOpts)
}

// MINIMUMLIQUIDITY is a free data retrieval call binding the contract method 0xba9a7a56.
//
// Solidity: function MINIMUM_LIQUIDITY() view returns(uint256)
func (_Pool *PoolCallerSession) MINIMUMLIQUIDITY() (*big.Int, error) {
	return _Pool.Contract.MINIMUMLIQUIDITY(&_Pool.CallOpts)
}
...
func (_Pool *PoolCaller) KLast(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Pool.contract.Call(opts, &out, "kLast")
...
//
// Solidity: function kLast() view returns(uint256)
func (_Pool *PoolSession) KLast() (*big.Int, error) {
	return _Pool.Contract.KLast(&_Pool.CallOpts)
}

// KLast is a free data retrieval call binding the contract method 0x7464fc3d.
//
// Solidity: function kLast() view returns(uint256)
func (_Pool *PoolCallerSession) KLast() (*big.Int, error) {
	return _Pool.Contract.KLast(&_Pool.CallOpts)
}
...
func (_Pool *PoolCaller) Price0CumulativeLast(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Pool.contract.Call(opts, &out, "price0CumulativeLast")
...
//
// Solidity: function price0CumulativeLast() view returns(uint256)
func (_Pool *PoolSession) Price0CumulativeLast() (*big.Int, error) {
	return _Pool.Contract.Price0CumulativeLast(&_Pool.CallOpts)
}

// Price0CumulativeLast is a free data retrieval call binding the contract method 0x5909c0d5.
//
// Solidity: function price0CumulativeLast() view returns(uint256)
func (_Pool *PoolCallerSession) Price0CumulativeLast() (*big.Int, error) {
	return _Pool.Contract.Price0CumulativeLast(&_Pool.CallOpts)
}
...
func (_Pool *PoolCaller) Price1CumulativeLast(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Pool.contract.Call(opts, &out, "price1CumulativeLast")
...
//
// Solidity: function price1CumulativeLast() view returns(uint256)
func (_Pool *PoolSession) Price1CumulativeLast() (*big.Int, error) {
	return _Pool.Contract.Price1CumulativeLast(&_Pool.CallOpts)
}

// Price1CumulativeLast is a free data retrieval call binding the contract method 0x5a3d5493.
//
// Solidity: function price1CumulativeLast() view returns(uint256)
func (_Pool *PoolCallerSession) Price1CumulativeLast() (*big.Int, error) {
	return _Pool.Contract.Price1CumulativeLast(&_Pool.CallOpts)
}
...
func (_Pool *PoolTransactor) Initialize(opts *bind.TransactOpts, _token0 common.Address, _token1 common.Address) (*types.Transaction, error) {
	return _Pool.contract.Transact(opts, "initialize", _token0, _token1)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _token0, address _token1) returns()
func (_Pool *PoolSession) Initialize(_token0 common.Address, _token1 common.Address) (*types.Transaction, error) {
	return _Pool.Contract.Initialize(&_Pool.TransactOpts, _token0, _token1)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _token0, address _token1) returns()
func (_Pool *PoolTransactorSession) Initialize(_token0 common.Address, _token1 common.Address) (*types.Transaction, error) {
	return _Pool.Contract.Initialize(&_Pool.TransactOpts, _token0, _token1)
}
...
func (_Pool *PoolTransactor) Swap(opts *bind.TransactOpts, amount0Out *big.Int, amount1Out *big.Int, to common.Address, data []byte) (*types.Transaction, error) {
	return _Pool.contract.Transact(opts, "swap", amount0Out, amount1Out, to, data)
}

// Swap is a paid mutator transaction binding the contract method 0x022c0d9f.
//
// Solidity: function swap(uint256 amount0Out, uint256 amount1Out, address to, bytes data) returns()
func (_Pool *PoolSession) Swap(amount0Out *big.Int, amount1Out *big.Int, to common.Address, data []byte) (*types.Transaction, error) {
	return _Pool.Contract.Swap(&_Pool.TransactOpts, amount0Out, amount1Out, to, data)
}

// Swap is a paid mutator transaction binding the contract method 0x022c0d9f.
//
// Solidity: function swap(uint256 amount0Out, uint256 amount1Out, address to, bytes data) returns()
func (_Pool *PoolTransactorSession) Swap(amount0Out *big.Int, amount1Out *big.Int, to common.Address, data []byte) (*types.Transaction, error) {
	return _Pool.Contract.Swap(&_Pool.TransactOpts, amount0Out, amount1Out, to, data)
}
...
func (_Pool *PoolFilterer) FilterMint(opts *bind.FilterOpts, sender []common.Address) (*PoolMintIterator, error) {
	...
	logs, sub, err := _Pool.contract.FilterLogs(opts, "Mint", senderRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Mint(address indexed sender, uint256 amount0, uint256 amount1)
func (_Pool *PoolFilterer) WatchMint(opts *bind.WatchOpts, sink chan<- *PoolMint, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Pool.contract.WatchLogs(opts, "Mint", senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
